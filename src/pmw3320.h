...
//#define PMW3320_REG_DELTA_XY_H 0x05
...
//#define PMW3320_REG_CRC0 0x0C
//#define PMW3320_REG_CRC1 0x0D
//#define PMW3320_REG_CRC2 0x0E
//#define PMW3320_REG_CRC3 0x0F
//#define PMW3320_REG_SELF_TEST 0x10

#define PMW3320_REG_PERFORMANCE 0x22
#define PMW3320_REG_MOTION_BURST 0x42
...
//#define PMW3320_REG_OBSERVATION 0x2D

#define PMW3320_REG_PIXEL_GRAB 0x0B
//#define PMW3320_REG_FRAME_GRAB 0x36

#define PMW3320_REG_POWER_UP_RESET 0x3A
#define PMW3320_REG_SHUTDOWN 0x3B

//#define PMW3320_REG_SPI_CLK_ON_REQ 0x41
#define PMW3320_REG_RES_STEP 0x85

#define PMW3320_REG_NOT_REV_ID 0x3F
#define PMW3320_REG_NOT_PROD_ID 0x4F

//#define PMW3320_REG_PRBS_TEST_CTL 0x47
//#define PMW3320_REG_SPI_PAGE0 0x7F
//#define PMW3320_REG_VCSEL_CTL 0x9E
//#define PMW3320_REG_LSR_CONTROL 0x9F
//#define PMW3320_REG_SPI_PAGE1 0xFF

/* Sensor identification values */
#define PMW3320_PRODUCT_ID 0x3F
...
//#define PMW3320_SPI_CLOCK_CMD_ENABLE 0xBA
//#define PMW3320_SPI_CLOCK_CMD_DISABLE 0xB5

/* Max register count readable in a single motion burst */
#define PMW3320_MAX_BURST_SIZE 10

/* Register count used for reading a single motion burst */
#define PMW3320_BURST_SIZE 7

/* Position in the motion registers */
#define PMW3320_X_L_POS 1
#define PMW3320_Y_L_POS 2
#define PMW3320_XY_H_POS 3
#define PMW3320_SHUTTER_H_POS 5
#define PMW3320_SHUTTER_L_POS 6

/* cpi/resolution range */
#define PMW3320_MAX_CPI 3200
#define PMW3320_MIN_CPI 200
...
#if defined(CONFIG_PMW3320_POLLING_RATE_250) || defined(CONFIG_PMW3320_POLLING_RATE_125_SW)
#define PMW3320_POLLING_RATE_VALUE 0x0D
#elif defined(CONFIG_PMW3320_POLLING_RATE_125)
#define PMW3320_POLLING_RATE_VALUE 0x00
#else
#error "A valid PMW3320 polling rate must be selected"
#endif

#ifdef CONFIG_PMW3320_FORCE_AWAKE
#define PMW3320_FORCE_MODE_VALUE 0xF0
#else
#define PMW3320_FORCE_MODE_VALUE 0x00
#endif

#define PMW3320_PERFORMANCE_VALUE (PMW3320_FORCE_MODE_VALUE | PMW3320_POLLING_RATE_VALUE)
